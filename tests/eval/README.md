...
language, drops the i18n citation, removes the redactor, or strips the Never-say
rule, a lint goes red. (Each lint was negative-control tested — it fails when its
