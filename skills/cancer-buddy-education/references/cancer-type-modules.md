...
Every cancer-type section in the handbook MUST have these 6 subsections, in this order, each with the heading shown:
...
### 患者最常问的 5 个问题
EXACTLY 5 questions, in patient voice (我 / 我家人 / 是不是), each with a 2-4 sentence direct, non-condescending answer. Surface common misconceptions — patients ask "为什么我没吸烟也得肺癌" not "what is the etiology of NSCLC".
...
End every cancer-type section with this standardized footer (verbatim):
```
...
- Length: 500-800 字 per cancer type, readable in 5-8 分钟 by a layperson
- Reading level: 初中文化 (junior-high reading level), avoid medical Latinate jargon (use 化疗 not 系统性细胞毒性药物治疗)
- Footer: `本内容为信息参考，具体方案与调整必须与主诊医生确认。` — verbatim, every section, no exceptions
