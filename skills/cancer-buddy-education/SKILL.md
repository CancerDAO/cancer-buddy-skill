...
- **Role = family**: general 2-page support brief by default. Include patient-specific disease/treatment facts only within a verified scope and explicit share consent; never add a one-sentence prognosis.
