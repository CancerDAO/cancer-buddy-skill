...
写给一个害怕的患者/家属，**不是写给医生**。规则（对齐 SKILL 的 **G-PATIENT-FIRST**）：
...
- **无** 6 维对照表、**无**证据分级术语、**无** PMID 轰炸——想看细节 → 指向 §B。
...
**别人试过的治疗方向**（不是推荐，是拿去问医生的选项）：
- **<方向一，如某类靶向/免疫组合>** —— 有几位情况部分像你的人试过这个方向。
- **<方向二>** —— …
- **<方向三>** —— …
...
**别人试过的治疗方向**（拿去问医生的选项，不是推荐）：
- **化疗 + 免疫联合、再看能不能转化手术** —— 有人在腹膜播散后走这个方向，播散一度消失后做了手术。
- **同步放化疗 + 免疫维持** —— 局部复发时有人走过这条。
- **针对特定靶点的方案** —— 前提是先做基因检测明确靶点（你爸目前没测）。
