...
**问城市的同时，先给两条今晚就能做的通用下一步**（不必等答复）：① 大医院的 **MDT / 多学科门诊挂号机制**（很多医院公众号 / APP 可约多学科门诊，去时带齐病历原件 + 影像片子）；② 若可能要跨省去北上广，提前办 **异地就医备案**（参保地线上就能办，影响报销），把它作为清单项列出。真正的命名短名单（含**具体医生 / MDT 门诊方向**、挂号路径、按城市查 ChiCTR + clinicaltrials.gov 的试验命中）在拿到城市后下一轮兑现——别只给医院名。
