...
3. **立即给出危机热线**（不省略、不简化、不放在末尾）：**唯一权威热线表是 [`../cancer-buddy-mind/references/crisis-resources.md`](../cancer-buddy-mind/references/crisis-resources.md)**——呈现该表的**完整内容**（不要在这里内联一份缩减子集，避免与权威表漂移）。热线**按地区给**（region-bound,不是 locale-bound）：患者在中国 → 给该表的完整中国表（12356 / 400-161-9995 / 010-82951332 / 021-64383562 / 广州 020-81899120 / 成都 028-87577510 / 青岛 0532-85669120 / 急救 120）；其它地区 → 给该地区已核实的危机线（如美国 988、英国 Samaritans 116 123、荷兰 113、本地急救号）；无法核实某地区热线时回退到"立即去最近医院急诊 + 当地急救号"。号码/机构名/急救号逐字不译。
