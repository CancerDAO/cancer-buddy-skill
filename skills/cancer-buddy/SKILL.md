...
description: |
  ...
  Triggers on: 抗癌搭子, 搭子, 患者导航, 帮我分析病情, 刚确诊, 病历整理, 数据保险箱, 宣教手册, 家属, 陪护, burnout, 睡不着, 焦虑, 抑郁, 吃什么, 忌口, 第二意见, 跨境会诊, 告不告诉, 不想让对方知道, 找医院, 找医生, MDT, 临床试验, 就诊准备, 复诊, 看医生, 严不严重, 能治好吗, 是不是晚期, 预后, 会不会复发, 要不要化疗.
---
...
| 只报一个自测数值（体温/血压/体重…） | 已有档案 → organize 微量观测快车道 / 段C；无档案 → 先会话记录，不为一条数值建全量档案 | 同左（写入需授权） | 通用监测建议 |
...
这些一律回：**"这部分要问你的主诊医生。你可以用搭子帮你整理问问题的清单。"** —— 但**别停在这一句**：先按下面「条件式教育」给一张一般性的条件地图（不判你的个案），再落回医生。**"不做个案判决" ≠ "什么都不讲"。**
