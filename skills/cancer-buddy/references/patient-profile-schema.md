...
> 📎 **Cross-repo interop surface** → see [`PATIENT_DIR_CONTRACT.md`](../../cancer-buddy-organize/references/PATIENT_DIR_CONTRACT.md) for the stable producer→consumer surface; this file remains the full producer-side field contract.
